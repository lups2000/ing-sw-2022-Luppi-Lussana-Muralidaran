...
class ColorNoInfluenceTest {
    ...
    void effect() throws NoPawnPresentException, TooManyPawnsPresent, TooManyTowersException, NoTowersException {
        ...
        game.getIslands().get(6).addStudent(PawnColor.BLUE);
        //island 6: 1 RED,2 BLUE + White Tower

        ColorNoInfluence colorNoInfluence=new ColorNoInfluence(game);
        colorNoInfluence.effect(PawnColor.RED);
        assertEquals(colorNoInfluence.getCost(),4);
        game.moveMotherNature(game.getIslands().get(6));
        //Teo influence 1,Paolo influence 2
